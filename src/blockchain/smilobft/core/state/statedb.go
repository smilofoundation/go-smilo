...
func (s *StateDB) GetSmiloPay(addr common.Address, blockNumber *big.Int) *big.Int {
	stateObject := s.getStateObject(addr)
	ret := common.Big0
	if stateObject != nil {
...
//
func (s *StateDB) AddSmiloPay(addr common.Address, amount *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) SubBalance(addr common.Address, amount, blockNumber *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) SubSmiloPay(addr common.Address, amount, blockNumber *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) SetBalance(addr common.Address, amount, blockNumber *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) SetSmiloPay(addr common.Address, amount *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) UpdateSmiloPay(addr common.Address, blockNumber *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (s *StateDB) clearJournalAndRefund() {
	if s.journal == nil || len(s.journal.entries) > 0 {
