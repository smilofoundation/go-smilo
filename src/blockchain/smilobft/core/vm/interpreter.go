...
type Interpreter interface {
	...
	Run(contract *Contract, input []byte, static, IsPrivate bool) ([]byte, error)
...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly, IsPrivate bool) (ret []byte, err error) {
	if in.intPool == nil {
