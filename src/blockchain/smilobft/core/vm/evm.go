...
func (evm *EVM) CreateWithAddress(caller ContractRef, code []byte, gas uint64, value *big.Int, addr common.Address, IsPrivate bool) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
