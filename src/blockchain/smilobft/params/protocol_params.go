...
const (
	...
	MinGasLimit          uint64 = 4712388   // Minimum the gas limit may ever be. (actual gasLimit on eth network)
...
func GetMaximumExtraDataSize(isSmilo bool) uint64 {
	if isSmilo {
		return SmiloMaximumExtraDataSize
	} else {
