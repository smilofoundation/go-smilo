...
func (e *NoRewardEngine) ProtocolOld() consensus.Protocol {
	panic("implement me")
}
...
func (e *NoRewardEngine) Finalize(chain consensus.ChainReader, header *types.Header, statedb *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	var block *types.Block
	var err error
	if e.rewardsOn {
		block, err = e.inner.Finalize(chain, header, statedb, txs, uncles, receipts)
	} else {
