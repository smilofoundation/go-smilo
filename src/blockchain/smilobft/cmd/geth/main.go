...
var (
	...
	app = utils.NewApp(gitCommit, "the go-smilo command line interface")
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	mylog.DoEmitCheckpoints = ctx.GlobalBool(utils.EmitCheckpointsFlag.Name)
