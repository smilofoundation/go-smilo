...
func TestSimulatedBackend_EstimateGas(t *testing.T) {
	...
	gas, err := sim.EstimateGas(bgCtx, smilobft.CallMsg{
		From:  testAddr,
		To:    &testAddr,
...
func TestSimulatedBackend_PendingAndCallContract(t *testing.T) {
	...
	res, err := sim.PendingCallContract(bgCtx, smilobft.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	})
	...
	res, err = sim.CallContract(bgCtx, smilobft.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	}, nil)
