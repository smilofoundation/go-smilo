...
func (b *SimulatedBackend) stateByBlockNumber(ctx context.Context, blockNumber *big.Int) (*state.StateDB,*state.StateDB, error) {
...
func (b *SimulatedBackend) CodeAt(ctx context.Context, contract common.Address, blockNumber *big.Int) ([]byte, error) {
	...
	statedb, _, err := b.stateByBlockNumber(ctx, blockNumber)
	if err != nil {
		return nil, err
	}
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (smilobft.Subscription, error) {
...
func (fb *filterBackend) EventMux() *cmn.TypeMux  { panic("not supported") }
