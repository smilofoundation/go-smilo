...
import (
	...
	"go-smilo/src/blockchain/smilobft/accounts/usbwallet/internal/trezor"
...
func (w *trezorDriver) SignTx(path accounts.DerivationPath, tx *types.Transaction, chainID *big.Int, isSmilo bool) (common.Address, *types.Transaction, error) {
	if w.device == nil {
