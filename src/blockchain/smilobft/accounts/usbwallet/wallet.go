...
type driver interface {
	...
	SignTx(path accounts.DerivationPath, tx *types.Transaction, chainID *big.Int, isSmilo bool) (common.Address, *types.Transaction, error)
}
...
func (w *wallet) SignTx(account accounts.Account, tx *types.Transaction, chainID *big.Int, isSmilo bool) (*types.Transaction, error) {
	...
	sender, signed, err := w.driver.SignTx(path, tx, chainID, true)
	if err != nil {
		return nil, err
	}
