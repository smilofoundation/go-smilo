...
// Source: src/blockchain/smilobft/consensus/tendermint/core/core_backend.go
...
func (m *MockBackend) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	m.ctrl.T.Helper()
...
func (m *MockBackend) Seal(chain consensus.ChainReader, block *types.Block, stop <-chan struct{}) (*types.Block, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBackendMockRecorder) Seal(chain, block, stop interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Seal", reflect.TypeOf((*MockBackend)(nil).Seal), chain, block, stop)
}
...
func (m *MockBackend) ProtocolOld() consensus.Protocol {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProtocolOld")
	ret0, _ := ret[0].(consensus.Protocol)
	return ret0
}

// Protocol indicates an expected call of Protocol
func (mr *MockBackendMockRecorder) ProtocolOld() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockBackend) Subscribe(types ...interface{}) *cmn.TypeMuxSubscription {
	...
	ret0, _ := ret[0].(*cmn.TypeMuxSubscription)
	return ret0
}
