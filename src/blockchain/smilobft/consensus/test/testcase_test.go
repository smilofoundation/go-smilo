...
func runTest(t *testing.T, test *testCase) {
	...
	//		goleak.IgnoreTopFunction("go-smilo/src/blockchain/smilobft/miner.(*worker).loop"),
	//		goleak.IgnoreTopFunction("go-smilo/src/blockchain/smilobft/miner.(*worker).updater"),
	//		goleak.IgnoreTopFunction("go-smilo/src/blockchain/smilobft/miner.(*worker).newWorkLoop.func1"),
	//	)
	//}

	// needed to prevent go-routine leak at go-smilo/src/blockchain/smilobft/metrics.(*meterArbiter).tick
