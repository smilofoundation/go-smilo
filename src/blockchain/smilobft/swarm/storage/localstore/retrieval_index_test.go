...
//
// # go test -benchmem -run=none go-smilo/src/blockchain/smilobft/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: go-smilo/src/blockchain/smilobft/swarm/storage/localstore
...
//
// go test -benchmem -run=none go-smilo/src/blockchain/smilobft/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: go-smilo/src/blockchain/smilobft/swarm/storage/localstore
