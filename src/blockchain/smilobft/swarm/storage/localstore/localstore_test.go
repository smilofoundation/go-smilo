...
import (
	...
	ch "go-smilo/src/blockchain/smilobft/swarm/chunk"
	"go-smilo/src/blockchain/smilobft/swarm/shed"
...
//
// # go test -benchmem -run=none go-smilo/src/blockchain/smilobft/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
